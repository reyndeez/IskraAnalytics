    ...
    <main className=" flex flex-col snap-y snap-proximity  h-screen ">
      ...
      <section className="min-h-screen flex items-center justify-start px-[5%] md:px-[10%]">
        ...
        <div className="md:w-3/5 space-y-12 text-center md:text-left">
          ...
          <p className="md:text-8xl font-bold text-brand">
            следи за<br />прогрессом,<br />достигай побед!
          </p>
          <p className="text-3xl font-medium text-brand leading-tight">
          ...
          className="text-brand font-medium text-2xl cursor-pointer hover:text-[#41479B] border px-4 py-2 shadow-md hover:border-[#41479B] rounded-xl transition-all duration-200 hover:shadow-lg">
            У меня есть код
            </Link>
        </div>
      ...
      <section className="min-h-screen flex flex-col justify-center py-10 px-[5%] md:px-[10%]">
        <div className="text-center md:text-left mb-16 space-y-3">
          <h2 className="text-8xl font-bold text-brand">
            Возможности платформы
        </h2>
        <p className="text-3xl text-brand/60">
      ...
      {/* Подвал */}
      {/* <footer className="bg-brand text-white py-12 px-[5%] md:px-[10%]">
