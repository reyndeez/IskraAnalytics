...
export function GroupAccordion({ group }: GroupAccordionProps) {
    ...
    return (
        <div className="w-full bg-brand rounded-3xl overflow-hidden shadow-md transition-all duration-300 mb-2">
            <button
            ...
            <div className={`transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? "max-h-250 pb-6 px-6" : "max-h-0"}`}>
    ...
    return (
        <div className="w-full bg-white rounded-2xl px-6 py-4 text-xl font-medium shadow-sm flex items-center justify-between">
            ...
            <button 
                ...
                className="cursor-pointer bg-brand text-white p-3 rounded-xl font-bold hover:bg-[#093d8c] transition-colors shadow-sm flex items-center justify-center"
            >
                <Info size={24} />
            </button>
                ...
                <div className="bg-brand p-8 text-white relative">
                    ...
                    <div className="flex items-center gap-6">
                        {loading ? (
                            ...
                            <div>
                                <h2 className="text-3xl font-extrabold uppercase tracking-[0.02em]">Карточка спортсмена</h2>
                                <p className="text-white/80 text-xl">Профиль внутриклубной системы</p>
                            </div>
                        ) : (
                            <div>
                        ...
                        <div className="flex flex-col gap-5 text-xl text-gray-800">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="flex flex-col bg-gray-50 p-4 rounded-2xl">
                                    ...
                                    <span className="font-bold text-brand">
                                        {details.birthDate ? new Date(details.birthDate).toLocaleDateString('ru-RU') : 'Не указана'}
                                    </span>
                                </div>
                                <div className="flex flex-col bg-gray-50 p-4 rounded-2xl">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div className="flex flex-col bg-gray-50 p-4 rounded-2xl">
                                    ...
                                    <span className="font-bold text-brand">{details.groupName || 'Без группы'}</span>
                                </div>
                                ...
                                >
                                    ...
                                    <div className={`p-2.5 rounded-xl transition-all ${copied ? 'bg-green-600 text-white' : 'bg-brand/10 text-brand group-hover:bg-brand group-hover:text-white'}`}>
