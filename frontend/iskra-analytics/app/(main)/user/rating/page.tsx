                        ...
                        <table className="w-full text-left table-auto">
                            ...
                            <tbody>
                                {leaderboard.map((item) => (
                                    <tr
                                        key={item.studentId}
                                        className="border-t-2 border-brand/10 text-xs sm:text-lg md:text-xl text-brand font-bold hover:bg-brand/5 transition-colors"
                                    >
                                        ...
                                        <td className="p-2 md:p-6">
                                            ...
                                            <div className="text-[9px] md:text-sm text-brand/50 font-normal mt-0.5">
                                                {item.createdAt}
                                            </div>
                                        </td>
                                        <td className="p-2 md:p-6">
