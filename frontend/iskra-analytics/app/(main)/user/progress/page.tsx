    ...
    return (
        <div className="p-8 pt-48 px-[10%] md:px-[15%] mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-12">
                <div>
                    <h1 className="text-6xl font-bold text-brand">Прогресс</h1>
                    <p className="text-brand/60 text-4xl mt-2 font-medium">Мониторинг личных достижений спортсмена</p>
                </div>
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center p-20 bg-white/40 backdrop-blur-md rounded-4xl border border-white/40">
                    ...
                    <p className="mt-4 text-brand font-semibold">Загружаем данные профиля...</p>
                </div>
            ) : studentId ? (
                <div className="flex flex-col gap-8">
                                ...
                                <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8'>                        
                                    ...
                                    <div className='p-8 bg-white/70 backdrop-blur-xl rounded-[2.5rem] border border-white/40 shadow-xl shadow-blue-900/5 flex flex-col justify-between min-h-60 transition-all hover:shadow-2xl hover:shadow-blue-900/10'>
                                        <div className='flex justify-between items-center mb-6'>
                                            <p className='text-xl font-extrabold text-brand uppercase tracking-[0.02em]'>Карточка спортсмена</p>
                                        </div>
                                        <div className='flex flex-row items-center gap-8'>
                                            <div className='flex flex-col items-center shrink-0'>
                                                <div className='bg-brand text-white w-28 h-28 rounded-4xl flex items-center justify-center text-4xl font-black shadow-xl shadow-blue-200 uppercase'>
                                                    {currentStudent?.firstName[0]}
                                                </div>
                                                <div className='mt-4 px-4 py-1.5 bg-brand rounded-xl shadow-lg shadow-blue-100'>
                                    ...
                                    {/* Карточка-рейтинг */}
                                    <div className='p-10 bg-linear-to-br from-brand to-[#04346e] rounded-4xl shadow-2xl shadow-blue-100 flex flex-col justify-between text-white relative overflow-hidden'>
                                        {(() => {
                    ...
                    <section className="w-full">
                        <div className='p-8 bg-white/60 backdrop-blur-xl rounded-[2.5rem] border border-white/40 shadow-xl shadow-blue-900/5'>
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
                                <div>
                                    <h3 className="text-xl font-extrabold text-brand uppercase tracking-[0.02em]">Динамика показателей</h3>
                                    <p className="text-lg text-muted font-medium">Прогресс по ключевым упражнениям</p>
                                </div>
                            ...
                            <div className="h-100 w-full mt-5">
                                {isChartLoading ? (
                                    ...
                                    <div className="flex items-center justify-center h-full border border-dashed border-gray-200 rounded-3xl">
                                        <p className="text-brand/60 font-medium text-2xl text-center">Недостаточно данных для построения графика (нужно минимум 3 записи)</p>
                                    </div>
                                )}
                            </div>
                    ...
                    <section className="w-full">
                        <div className='p-8 bg-white/60 backdrop-blur-xl rounded-[2.5rem] border border-white/40 shadow-xl shadow-blue-900/5'>
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
                                <div>
                                    <h3 className="text-xl font-extrabold text-brand uppercase tracking-[0.02em]">Зоны роста</h3>
                                    <p className="text-lg text-muted font-medium">Интеллектуальные рекомендации по развитию</p>
                                </div>
                            </div>
                                            ...
                                            <div className="grid grid-cols-[auto_1fr] gap-6 items-start">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-3 mb-2">
                                                        <h4 className="text-2xl font-black text-brand">
                                                            {rec.name}
                                                        </h4>

                                                        <span className="px-3 py-1 bg-blue-100  text-brand text-xs font-bold rounded-full">
                                                            Потенциал роста
                                                        </span>
                                                    </div>
                                                    ...
                                                    <div className="relative p-5 bg-brand/5 rounded-2xl border border-brand/10">
                ...
                <div className="text-center p-20 bg-white/60 backdrop-blur-md rounded-4xl shadow-lg border border-white/40">
                    ...
                    <button 
                        className="px-5 py-3 bg-brand cursor-pointer rounded-xl text-white text-2xl hover:bg-[#41479B] shadow-md hover:shadow-lg transition-all" 
